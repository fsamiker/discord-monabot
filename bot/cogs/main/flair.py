...
class Flair(commands.Cog):
    ...
    async def on_ready(self):
        ...
        self.emojis['Xinyan'] = self.bot.get_emoji(790901142908698624)
        self.emojis['Albedo'] = self.bot.get_emoji(791531736247828480)
        self.emojis['Eula'] = self.bot.get_emoji(847074877768728646)
        self.emojis['Yanfei'] = self.bot.get_emoji(847075103245074484)
